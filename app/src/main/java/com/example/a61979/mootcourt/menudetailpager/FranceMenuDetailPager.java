 ...
 * @updateDes ${TODO}
 */
public class FranceMenuDetailPager extends MenuDetailBasePager {

    private TextView textview;

    public FranceMenuDetailPager(Context context) {
        super(context);
    }
    ...
    public void initData() {
        ...
        LogUtil.e("法国页面数据被初始化了");
        textview.setText("法国页面内容");
    }
}
