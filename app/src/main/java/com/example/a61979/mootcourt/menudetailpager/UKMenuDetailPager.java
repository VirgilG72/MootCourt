...
import com.example.a61979.mootcourt.menudetailpager.tabdetailpager.UKDetailPager;
...
public class UKMenuDetailPager extends MenuDetailBasePager {
     ...
     * 页签页面的集合
     */
    private ArrayList<UKDetailPager> tableDetailPagers;
    public UKMenuDetailPager(Context context, DiscoverPagerBean2.DetailPagerData detailPagerData) {
        super(context);
    ...
    public void initData() {
        ...
        for (int i = 0; i < children.size(); i++) {
            tableDetailPagers.add(new UKDetailPager(context,children.get(i)));
        }
        //设置viewpager的适配器
    ...
    private class MyChinaMenuDetailPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            UKDetailPager tabDetailPager = tableDetailPagers.get(position);
